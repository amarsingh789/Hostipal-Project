...
// const HeroSection = () => {
//   return (
//     <div className='relative w-full min-h-[700px] md:h-[650px] md:min-h-[650px] bg-[#F4F7F6] overflow-hidden flex flex-col md:block mt-2 md:mt-4 group rounded-b-[3rem] md:rounded-[2.5rem] md:bg-clinic-green'>
      
//       {/* ── MOBILE: PREMIUM CURVED BACKGROUND ── */}
//       <div className="md:hidden absolute top-0 left-0 w-full h-[90%] bg-clinic-green rounded-b-[3rem] shadow-xl z-0 overflow-hidden">
//          <div className="absolute top-[-20%] left-[-10%] w-[300px] h-[300px] bg-[#0F766E] rounded-full blur-[80px] opacity-60"></div>
//          <h1 className='absolute top-20 left-0 w-full text-center font-poppins text-[18vw] font-black text-white/5 select-none uppercase tracking-tighter leading-none z-0'>
//            Health <br/> Care
//          </h1>
//       </div>

//       {/* ── DESKTOP: OLD FULL BACKGROUND ── */}
//       <div className="hidden md:block absolute inset-0 z-0">
//         <h1 className='absolute top-20 left-0 w-full text-center font-poppins text-[180px] font-black text-white/5 select-none uppercase tracking-tighter leading-none z-0'>
//           Healthcare
//         </h1>
//       </div>

//       {/* ── DESKTOP FLOATING BADGES (Hidden on Mobile) ── */}
//       <div className="hidden md:flex absolute top-[25%] left-[10%] z-30 bg-white/10 backdrop-blur-xl px-5 py-3 rounded-2xl items-center gap-3 border border-white/20 shadow-2xl animate-bounce-slow">
...
//       <div className="hidden md:flex absolute top-[40%] right-[10%] z-30 bg-white/10 backdrop-blur-xl px-5 py-3 rounded-2xl items-center gap-3 border border-white/20 shadow-2xl animate-float">
...
//       {/* ── DOCTOR IMAGE ── */}
//       {/* 🚀 FIXED: Desktop Image Constraints restored 🚀 */}
//       <div className="absolute top-[15%] md:top-auto md:bottom-0 left-0 right-0 h-[60%] md:h-[95%] flex justify-center items-end pointer-events-none z-10 overflow-visible md:overflow-hidden">
//         <img 
//           src={doctorImg} 
//           alt="Doctor" 
//           // Mobile gets scale, Desktop goes back to normal object-contain without scale manipulation
...
//           style={{
//             // Mask is active for both, but tuned for Desktop bottom blend
...
//       {/* ── MOBILE: FLOATING INFO CARD (Overlaps Image) ── */}
//       <div className="md:hidden absolute bottom-4 left-4 right-4 z-30 bg-white/90 backdrop-blur-xl p-5 rounded-3xl shadow-[0_10px_40px_rgba(5,59,50,0.15)] border border-white">
//         <div className="flex justify-between items-start mb-4">
//           <div>
//             <div className="flex items-center gap-1.5 mb-1 bg-green-50 text-green-700 w-fit px-2 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wider">
//               <Star size={10} className="fill-green-700" /> Top Rated
//             </div>
//             <h3 className="text-[#021814] font-poppins font-bold text-xl leading-tight">Dr. Ananya Singh</h3>
//             <p className="text-[#0F766E] text-xs font-semibold mt-0.5">Endocrinologist</p>
//           </div>
...
//         <div className="flex items-center gap-2 text-xs font-medium text-gray-500 mb-5 bg-gray-50 p-2.5 rounded-xl border border-gray-100">
...
//           <Link 
//             to='/appointment' 
//             className='flex-1 text-center bg-[#053b32] hover:bg-[#0F766E] text-[#dfff4f] font-poppins font-bold px-6 py-4 rounded-2xl transition-all shadow-lg active:scale-95 text-sm'
//           >
//             Book Consultation
//           </Link>
//         </div>
...
//       {/* 🚀 FIXED: Z-Index and Layout for Desktop Bottom Area 🚀 */}
//       <div className="hidden md:flex absolute bottom-0 left-0 w-full p-10 justify-between items-end z-20 pointer-events-none">
        
//         {/* Desktop Name Tag */}
//         <div className="absolute bottom-[20%] left-[12%] z-30 bg-white/10 backdrop-blur-md p-4 rounded-3xl border border-white/10 flex items-center gap-4 animate-float delay-75 w-max pointer-events-auto">
...
//         <p className="max-w-[280px] text-white/60 text-[11px] tracking-[0.2em] font-medium leading-relaxed uppercase pointer-events-auto">
...
//           <Link 
//             to='/appointment' 
//             className='bg-clinic-yellow hover:bg-white text-clinic-green font-poppins font-bold px-8 py-4 rounded-2xl transition-all shadow-lg active:scale-95'
//           >
//             Book Consultation
//           </Link>
//           <Link 
//             to='/appointment' 
//             className="w-14 h-14 flex items-center justify-center bg-white/10 hover:bg-clinic-yellow text-white hover:text-clinic-green rounded-2xl border border-white/10 transition-all backdrop-blur-md"
//           >
