...
//   // 🚀 Updated: Shadcn passes direct string value instead of event object
...
//           .si { display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:13px; background:var(--cr); border:1px solid var(--bdl); transition:all .18s; }
//           .si:hover { background:var(--crd); border-color:var(--bd); }
//           .sic { width:32px; height:32px; border-radius:9px; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
//           .slb { font-size:9px; font-weight:700; color:var(--inkm); letter-spacing:.08em; text-transform:uppercase; margin:0; }
//           .svl { font-size:13px; font-weight:700; color:var(--ink); margin:0; }
...
//           /* Card */
//           .fc { background:var(--wh); border:1px solid var(--bdl); border-radius:var(--rc); box-shadow:0 2px 8px rgba(0,0,0,.06),0 12px 32px rgba(0,0,0,.08); }
...
//           .lf-wrap { display:flex; align-items:center; gap:12px; padding:14px 16px; border-radius:16px; background:var(--crm); border:1px solid var(--bdl); }
...
//           /* 🚀 REFINED SELECT FOR BLOOD GROUP 🚀 */
...
//           [role="listbox"] { background: var(--wh) !important; border: 1.5px solid var(--bd) !important; border-radius: 16px !important; font-family: var(--sf) !important; box-shadow: 0 8px 28px rgba(0,0,0,.1) !important; padding: 6px !important; }
//           [role="option"] { border-radius: 8px !important; font-size: 14px !important; cursor: pointer !important; padding: 10px 12px !important; }
...
//           /* Live name preview card */
//           .np { display:flex; align-items:center; gap:14px; padding:14px 18px; border-radius:16px; background:linear-gradient(135deg,var(--gp),#d4eee6); border:1px solid #c2ddd5; margin-bottom:20px; animation:fadeIn .3s ease; }
//           @keyframes fadeIn { from{opacity:0;transform:translateY(-4px)} to{opacity:1;transform:translateY(0)} }
...
//           /* Gender pills */
//           .gpills { display:flex; gap:8px; flex-wrap:wrap; }
//           .gp { padding:9px 14px; border-radius:99px; font-size:13px; font-weight:500; border:1.5px solid var(--bd); background:var(--cr); color:var(--inks); cursor:pointer; transition:all .16s; font-family:var(--sf); }
//           @media (min-width: 640px) { .gp { padding:9px 18px; } }
//           .gp:hover:not(:disabled) { border-color:var(--gm); color:var(--gm); background:var(--gp); }
//           .gp.sel { background:var(--gm); border-color:var(--gm); color:#dfff4f; font-weight:700; }
//           .gp:disabled { opacity:.5; cursor:not-allowed; border-color:transparent; background:var(--crm);}
...
//           /* Buttons */
//           .btg { flex:1; height:40px; padding:0 14px; border-radius:12px; background:transparent; color:var(--inks); font-family:var(--sf); font-size:13px; font-weight:500; border:1.5px solid var(--bd); cursor:pointer; display:inline-flex; align-items:center; justify-content:center; gap:7px; transition:all .18s; }
//           @media (min-width: 640px) { .btg { flex:none; padding:0 18px; } }
//           .btg:hover { background:var(--crd); }
//           .btp { flex:1; height:40px; padding:0 14px; border-radius:12px; background:var(--gm); color:#dfff4f; font-family:var(--sf); font-size:13px; font-weight:700; border:none; cursor:pointer; display:inline-flex; align-items:center; justify-content:center; gap:7px; box-shadow:0 3px 12px rgba(15,61,48,.22); transition:background .18s,transform .12s; }
...
import {
  User, Mail, Phone, MapPin, Calendar, Activity,
  Shield, Camera, Save, X, Droplet, Ruler, Edit2,
  ChevronDown, Check, Lock, AlertCircle, Heart,
} from "lucide-react";
