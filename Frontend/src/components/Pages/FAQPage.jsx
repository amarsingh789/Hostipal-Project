...
const FAQPage = () => {
  const faqs = [
    {
      ...
      answer:
        "Add any additional information like your medical history or preferences for a personalized healthcare experience.",
    },
    {
      question: "What types of health services are available?",
      answer:
        "We offer a wide range of services including general checkups, specialized consultations, diagnostic imaging, and 24/7 emergency trauma care.",
    },
    {
      question: "Can I book appointments online?",
      answer:
        "Yes! You can book, reschedule, or cancel your appointments directly through our patient portal or mobile application.",
    },
    {
      question: "Do you accept international insurance?",
      answer:
        "We accept most major international insurance providers. Please contact our billing desk with your policy details for verification.",
    },
    {
      question: "Can I book same-day appointments",
      answer:
        "Yes! Our instant video consultation connects you with a certified doctor within 60 seconds, 24/7.",
    },
    {
      question: "How do I access my lab reports?",
      answer:
        "Once ready, your lab reports will be automatically uploaded to your secure Ziva patient dashboard. You will also receive an SMS notification.",
    },
  ];
  ...
  return (
    <div
      className="relative w-full py-32 px-6 lg:px-12 bg-[#f8fafc] font-inter overflow-hidden"
      id="faq"
    >
      {/* 2-Column Layout */}
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        <div className="lg:w-1/3 flex flex-col pt-4">
          ...
          <p className="text-gray-500 text-lg mb-10">
            Find everything you need to know about our medical services,
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] border border-gray-100 relative overflow-hidden group">
            ...
            <h3 className="text-xl font-bold font-poppins text-gray-900 mb-2 relative z-10">
            ...
            <button
              onClick={() =>
                (window.location.href =
                  "mailto:support@zivahealthcare.com?subject=Need%20Support%20Assistance")
              }
              className="w-full py-4 rounded-2xl bg-clinic-green text-white font-bold hover:bg-clinic-yellow hover:text-clinic-green transition-all duration-300 flex items-center justify-center gap-2 relative z-10 shadow-lg shadow-clinic-green/20"
            >
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`shrink-0 transition-transform duration-500 ${isActive ? "rotate-180" : "rotate-0"}`}
                  >
                    <ChevronDown
                      size={24}
                      className={
                        isActive ? "text-clinic-yellow" : "text-gray-400"
                      }
                    />
                  </div>
                </button>
                ...
                >
                  <div className="overflow-hidden">
                    <div className="px-6 md:px-8 pb-6 md:pb-8 pt-0">
                      <p
                        className={`text-base leading-relaxed ${isActive ? "text-white/80" : "text-gray-600"}`}
                      >
                        {faq.answer}
                      </p>
                    </div>
